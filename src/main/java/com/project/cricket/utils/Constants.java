...
public final class Constants {
	...
	public static final String MATCH_URL = "https://www.espncricinfo.com/matches/engine/match/%s.html";
	public static final String MJSON_URL = "https://www.espncricinfo.com/matches/engine/match/%s.json";
